...
export class MembersComponent implements OnInit, OnDestroy {
  ...
  */
  constructor(
    ...
    //Get the member type
    _globalService.getMemberType().subscribe((MemberType) => {
    ...
    _universityService.getMembers().subscribe((Members) => {
  ...
  */
  loadDetail(member: {
    ...
    correo_integrante: string;
    cedula_integrante: string;
    id_facultad: number;
    id_tipo_integrante: number;
  }) {
  ...
  */
  get rm() {
    return this.member_form.controls;
  }
  ...
  */
  get um() {
    return this.update_member_form.controls;
  }
  ...
  updateMember() {
    ...
    const member_lastname = this.update_member_form.get("member_lastname")
      .value;
    const member_email = this.update_member_form.get("member_email").value;
    const member_document = this.update_member_form.get("member_document")
      .value;
  ...
  */
  deleteMember() {
    ...
    //Method
    this._universityService.deleteMember(member_id).subscribe((data) => {
  ...
  */
  refreshData() {
    //Get the members list
    this._universityService.getMembers().subscribe((Members) => {
      const ELEMENT_DATA = Members;
      //Get the elements
      this.list_members_aux = new MatTableDataSource(ELEMENT_DATA);
      this.list_members_aux.paginator = this.paginator;
