...
export class UsersComponent implements OnInit, OnDestroy
{
  ...
  */
              ...
              private changeDetectorRef: ChangeDetectorRef)
  {
    ...
    //Get the user list
    this._settingsService.getUsers()
    .subscribe(Users => {
  ...
  */
  ngOnInit()
  {
    ...
    this.user_form = this.formBuilder.group({
            user_name:             ['',   [Validators.required, Validators.maxLength(40), Validators.pattern('^[A-Za-zñÑáéíóúÁÉÍÓÚ ]+$')]],
            user_lastname:         ['',   [Validators.required, Validators.maxLength(40), Validators.pattern('^[A-Za-zñÑáéíóúÁÉÍÓÚ ]+$')]],
            user_faculty:          ['',   [Validators.required]],
            user_type:             ['1',  [Validators.required]],
            user_email:            ['',   [Validators.required, Validators.email,    Validators.maxLength(70)]],
            user_password:         ['',   [Validators.required, Validators.minLength(5), Validators.maxLength(30)]],
    ...
    this.update_user_form = this.formBuilder.group({
            ...
            user_password:         ['',   [Validators.minLength(5), Validators.maxLength(30)]],
            user_confirm_password: ['']
    },
    {
      validator: this.checkPasswords
  ...
  ******************************************************************************
  */
  get ru() { return this.user_form.controls; }
  ...
  registerUser()
  {
    ...
    const user_confirm_password = this.user_form.get('user_confirm_password').value;

    this._settingsService.registerUser(user_name, user_lastname, user_faculty,
                                       user_type, user_email,    user_password,
                                       user_confirm_password)
    .subscribe(data=>
    {
  ...
  ******************************************************************************
  */
  get uu() { return this.update_user_form.controls; }
  ...
  updateUser()
  {
    ...
    const user_confirm_password = this.update_user_form.get('user_confirm_password').value;

    this._settingsService.updateUser(user_id,       user_name,     user_lastname,
                                     user_faculty,  user_type,     user_state,
                                     user_email,    user_password, user_confirm_password)
    .subscribe(data=>
    {
  ...
  */
  deleteUser()
  {
    ...
    //Method
    this._settingsService.deleteUser(user_id)
    .subscribe(data=>
    {
