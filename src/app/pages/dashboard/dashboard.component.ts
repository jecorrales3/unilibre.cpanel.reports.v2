...
export class DashboardComponent implements OnInit
{
  ...
  */
  constructor(public _dashboardService:DashboardService)
  {
    ...
    _dashboardService.getReportCounters()
    .subscribe(ReportCounters => {
      this.report_counter = ReportCounters;
      this.getReportCounters();
    });

    //Get the report counter list
    _dashboardService.getReportPercentage()
    .subscribe(ReportPercentage => {
    ...
    _dashboardService.getReportList()
