...
export class ProgramsComponent implements OnInit, OnDestroy {
  ...
  */
  constructor(
    ...
    //Get the faculties
    _universityService.getPrograms().subscribe((Programs) => {
  ...
  */
  loadDetail(program: {
    id_programa_facultad: number;
    nombre_programa_facultad: string;
    titulo_programa_facultad: string;
    id_facultad: number;
  }) {
  ...
  */
  get rp() {
    return this.program_form.controls;
  }
  ...
  registerProgram() {
    ...
    const program_title_name = this.program_form.get("program_title_name")
      .value;
    const program_faculty = this.program_form.get("program_faculty").value;

    this._universityService
      .registerProgram(program_name, program_title_name, program_faculty)
      .subscribe((data) => {
  ...
  */
  get up() {
    return this.update_program_form.controls;
  }
  ...
  updateProgram() {
    ...
    const program_title_name = this.update_program_form.get(
      "program_title_name"
    ).value;
    const program_faculty = this.update_program_form.get("program_faculty")
      .value;
  ...
  */
  deleteProgram() {
    ...
    //Method
    this._universityService.deleteProgram(program_id).subscribe((data) => {
  ...
  */
  refreshData() {
    //Get the faculties
    this._universityService.getPrograms().subscribe((Programs) => {
      const ELEMENT_DATA = Programs;
      //Get the elements
      this.list_programs_aux = new MatTableDataSource(ELEMENT_DATA);
      this.list_programs_aux.paginator = this.paginator;
