...
export class ProfileComponent implements OnInit {
  ...
  */
  constructor(
    ...
    _settingsService.getProfile().subscribe((Profile) => {
  ...
  */
  ngOnInit() {
    //Message
    this.toastr.warning(
      "Al actualizar cualquier información del usuario se procederá a cerrar la sesión actual.",
      "WARNING",
      {
        timeOut: 7000,
  ...
  */
  ...
  openPasswordModal(passwordTemplate: TemplateRef<any>) {
    this.modalRef = this.modalService.show(passwordTemplate, this.config);
  }
  ...
  */
  ...
  userForm() {
    ...
    this._settingsService
      .updateProfile(user_name, user_lastname, user_email, user_faculty)
      .subscribe((data) => {
  ...
  */
  ...
  passwordForm() {
    ...
    this._settingsService
      .updatePasswordProfile(old_password, new_password, confirm_password)
      .subscribe((data) => {
