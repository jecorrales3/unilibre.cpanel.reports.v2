...
export class C2Component implements OnInit
{
  ...
  */
  ngOnInit()
  {
    ...
    if (JSON.parse(localStorage.getItem("report_settings_c2")) != null)
    {
      let header_settings = JSON.parse(localStorage.getItem("report_settings_c2"));
    ...
    //Get value of local storage
    if (JSON.parse(localStorage.getItem("report_students_c2")) != null)
    {
      //Get the value of local storage
      this.report_students_c2 = JSON.parse(localStorage.getItem("report_students_c2"));
      //Message
    ...
    //Get value of local storage
    if (JSON.parse(localStorage.getItem("report_members_c2")) != null)
    {
      //Get the value of local storage
      this.report_members_c2 = JSON.parse(localStorage.getItem("report_members_c2"));
      //Message
  ...
  */
  ...
  registerSetting()
  {
    ...
    //Clear LocalStorage
    localStorage.removeItem('report_settings_c2');
    //Clear array
    this.data_settings = [];
    //Add new elements
    ...
    //Set item
    localStorage.setItem("report_settings_c2", JSON.stringify(this.data_settings));
    //Get Item
    this.report_settings_c2 = JSON.parse(localStorage.getItem("report_settings_c2"));
  ...
  */
  ...
  registerStudent()
  {
    ...
    if(JSON.parse(localStorage.getItem("report_students_c2")) != null)
    {
      ...
      this.data_students = JSON.parse(localStorage.getItem("report_students_c2"));
    }
    ...
    //Set item
    localStorage.setItem("report_students_c2", JSON.stringify(this.data_students));
    //Get Item
    this.report_students_c2 = JSON.parse(localStorage.getItem("report_students_c2"));
  ...
  deleteStudent(id)
  {
    var students = JSON.parse(localStorage.getItem("report_students_c2"));
    ...
    localStorage.setItem("report_students_c2", JSON.stringify(students));
    //Get the results
    this.report_students_c2 = JSON.parse(localStorage.getItem("report_students_c2"));

    //Get value of local storage
    if (this.report_students_c2.length > 0)
    {
      //Message
      this.messageListStudents = false;
    }
    else
    {
      ...
      this.messageListStudents = true;
      //Clear LocalStorage
      localStorage.removeItem('report_students_c2');
    }
  };
  ...
  */
  ...
  registerMember()
  {
    ...
    else if(this.report_members_c2.length == 3)
    {
      //Show the result of the action
    ...
    {
      //Push the object array
      this.data_members = JSON.parse(localStorage.getItem("report_members_c2"));
    }
    ...
    //Set item
    localStorage.setItem("report_members_c2", JSON.stringify(this.data_members));
    //Get Item
    this.report_members_c2 = JSON.parse(localStorage.getItem("report_members_c2"));
  ...
  deleteMember(id)
  {
    var members = JSON.parse(localStorage.getItem("report_members_c2"));
    ...
    localStorage.setItem("report_members_c2", JSON.stringify(members));
    //Get the results
    this.report_members_c2 = JSON.parse(localStorage.getItem("report_members_c2"));

    //Get value of local storage
    if (this.report_members_c2.length > 0)
    {
      //Message
      this.messageListMembers = false;
    }
    else
    {
      ...
      this.messageListMembers = true;
      //Clear LocalStorage
      localStorage.removeItem('report_members_c2');
    }
  };
  ...
  */
  generateReport()
  {
    ...
    else if (this.report_students_c2.length == 0)
    {
      //Show the result of the action
    ...
    else if (this.report_members_c2.length == 0)
    {
      //Show the result of the action
    ...
    //Get values
    let report_settings_c2 = JSON.parse(localStorage.getItem("report_settings_c2"));
    let report_students_c2 = JSON.parse(localStorage.getItem("report_students_c2"));
    let report_members_c2  = JSON.parse(localStorage.getItem("report_members_c2"));

    this._controlService.registerReportC2(report_settings_c2, report_students_c2, report_members_c2)
    .subscribe(data=>
    {
