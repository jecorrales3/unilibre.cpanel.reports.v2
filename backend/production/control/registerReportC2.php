<?php
  ...
  */
  ...
  if(isset($_POST))
    ...
    $state_consecutive = validateConsecutiveC2($user_faculty_id);
    $consecutive_data  = getConsecutiveDataC2($user_faculty_id);
          ...
          */
          ...
          if ($configuration_id)
          {
            ...
            */
            ...
            foreach ($_POST['report_students_c2'] as $student)
            {
            ...
            */
            ...
            foreach ($_POST['report_members_c2'] as $member)
            {
