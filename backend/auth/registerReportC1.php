<?php
  ...
  */
  ...
  if(isset($_POST))
    ...
    $program_id   = $_POST['report_settings_c1'][0]['programa_reporte'];
    ...
    $data_consecutive  = getConsecutiveDataC1($user_faculty_id);
          ...
          */
          ...
          if ($configuration_id)
          {
            ...
            */
            ...
            foreach ($_POST['report_students_c1'] as $student)
            {
