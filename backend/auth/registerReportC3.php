<?php
  ...
  *****************************     UNILIBRE      *****************************
  *****************************************************************************
  ** @description  The PHP document register a report (C3)                   **
  ...
  */
  ...
  if(isset($_POST))
    ...
    $program_id   = $_POST['report_settings_c3'][0]['programa_reporte'];
          ...
          */
          ...
          if ($configuration_id)
          {
            ...
            */
            ...
            foreach ($_POST['report_students_c3'] as $student)
            {
            ...
            */
            ...
            foreach ($_POST['report_members_c3'] as $member)
            {
